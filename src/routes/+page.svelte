...
<section class="p-8 mt-10">
	...
	<p class="w-3/4 mx-auto mt-8 text-lg leading-7 text-gray-600">
		...
		fix the problem. We decided to create this website to educate customers about the various types
		of foundation repair work that we specialize in, such as helical piers, polyurethane structural
	...
	<p class="w-3/4 mx-auto mt-8 text-lg leading-7 text-gray-600">
		...
		follow up to schedule the inspection / project design meeting. This includes coming to your
		property to perform a full inspection, then going over the best repair plan in detail. It also
		includes scheduling crews to perform the work, helping you with payment options,
